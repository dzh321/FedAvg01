...
class LocalUpdate(object):
    ...
    def train_val_test(self, dataset, idxs):
        ...
        trainloader = DataLoader(DatasetSplit(dataset, idxs_train),batch_size=self.args.local_bs, shuffle=True)  # 这里的DatasetSplit返回的是图像和标签，但是DataLoader好像不需要输入标签？？？
